...
abstract class MyTransportation extends MyEnum {
    ...
    static final MyTransportation TRAIN = new MyTransportation("TRAIN", 110) {
        int fare(int distance) {return distance*BASIC_FARE;}
    };

    static final MyTransportation SHIP = new MyTransportation("SHIP", 130) {
        int fare(int distance) {return distance*BASIC_FARE;}
    };
...
public class EnumEx4 {
    public static void main(String[] args) {
        ...
        System.out.println(MyTransportation.AIRPLANE.fare(1000));
